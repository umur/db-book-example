-- Cinetrack chapter-5 seed.
-- Larger than chapter-2: 500 movies, 5,000 users, 500,000 view_events.
-- The big view_events table is what makes the sort in memory-tour.sql spill
-- under the chapter's deliberately small work_mem = 8MB.

BEGIN;

TRUNCATE TABLE view_events, watchlists, reviews, ratings, users, movies
