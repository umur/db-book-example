-- Cinetrack chapter-3 seed.
-- Identical shape to chapter-2: ~100 movies, ~50 users, ~500 ratings, ~50 reviews.
...
-- One oversized body so TOAST inspection in section 3.6 has something to find.
INSERT INTO reviews (user_id, movie_id, body)
VALUES (1, 1, repeat('x', 50000));
