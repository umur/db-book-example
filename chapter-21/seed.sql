-- Cinetrack chapter-21 seed.
-- 100 movies, 50 users, 500 ratings, 200 reviews. Re-runnable.
-- The reviews count is higher than chapter 15 to make the chunked
-- backfill in migration-tour.sql visible across multiple batches.
