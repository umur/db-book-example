-- Cinetrack chapter-4 seed.
-- Smaller starter than chapter-2 because the WAL tour generates its own
-- write volume. Re-runnable.
...
SELECT
    ((g - 1) % 25) + 1,
    ((g * 13) % 50) + 1,
    'A first-pass review for the WAL tour.'
